...
services = [
    {"name": "Premium Support", "description": "24/7 priority support with 1-hour response time.", "price": 19.99, "period": "monthly"},
    {"name": "Installation Service", "description": "Professional installation of your products by certified technicians.", "price": 49.99, "period": "one-time"},
    {"name": "Extended Warranty", "description": "Extend your product warranty by an additional 2 years.", "price": 29.99, "period": "yearly"},
    {"name": "Training Session", "description": "One-on-one training session to get the most out of your products.", "price": 79.99, "period": "one-time"}
]
