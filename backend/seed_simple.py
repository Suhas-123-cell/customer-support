...
products = [
    {"name": "SuperWidget", "description": "Our flagship product with amazing features A and B."},
    {"name": "MegaGadget", "description": "Ultra fast with long battery life and AI-powered capabilities."},
    {"name": "TechPro X1", "description": "Professional-grade tool for serious users."},
    {"name": "SmartHome Hub", "description": "Control all your smart devices from one central location."}
]
...
services = [
    {"name": "Premium Support", "description": "24/7 priority support with 1-hour response time."},
    {"name": "Installation Service", "description": "Professional installation of your products by certified technicians."},
    {"name": "Extended Warranty", "description": "Extend your product warranty by an additional 2 years."},
    {"name": "Training Session", "description": "One-on-one training session to get the most out of your products."}
]
